...
//import  fontFamily from "https://fonts.googleapis.com/css2?family=Pacifico&display=swap";
...
class AnaMeroiu extends React.Component {
    ...
    constructor(props) {
        ...
        const afisResources = () => {
            asyncR('/getResources', {numeProfesor: 'Ana Meroiu'}, (error, res) => {
...
export default withStyles(style)(AnaMeroiu);
