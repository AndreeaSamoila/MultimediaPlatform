...
class BiancaVilsanescu extends React.Component {
    ...
    constructor(props) {
        ...
        const afisResources = () => {
            asyncR('/getResources', {numeProfesor: 'Bianca Vilsanescu'}, (error, res) => {
...
export default withStyles(style)(BiancaVilsanescu);
